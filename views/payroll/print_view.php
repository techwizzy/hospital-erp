...
<section class="invoice"  style=" max-width:700px;">
   <div class="row invoice-info">
          ...
          <div class="col-sm-4 invoice-col">
            <stroong>Payroll No: <?= $payslip->Employee_id ?> </strong>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered  print-table order-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                             <td><strong>Gross Pay:</strong></td> <td><strong><?php echo number_format($payslip->Monthly_salary); ?>.00</strong></td>
                             </tr>
                            <tr>
                              <td>NSSF Pension Contribution: </td><td> <?php echo number_format($payslip->NSSF); ?>.00</td>
                            </tr>
                             <tr>
                              <td>PAYE: </td><td><?php echo number_format($payslip->PAYE); ?>.00</td>
                            </tr>
                            <tr>
                              <td>NHIF Contribution: </td><td><?php echo number_format($payslip->NHIF); ?>.00</td>
                            </tr>
                            
                             <tr>
                              <td>Loan Repayment: </td> <td><?php echo number_format($payslip->Loan); ?>.00</td>
                             </tr>
                               <?php foreach($deductions as $deduction){ ?>
                                 <tr>
                              
                              <td>Deduction:<?= $deduction->Title; ?> </td><td><?php echo number_format($deduction->Amount); ?>.00</td>
                            
                            </tr>
                              <?php } ?>
                          <tr>
                              <th>Net Salary: </th><th><?php echo number_format($payslip->Monthly_salary - $payslip->NSSF -$payslip->PAYE- $payslip->NHIF-$payslip->Loan-$payslip->Deductions); ?>.00</th>
                   </tr>
