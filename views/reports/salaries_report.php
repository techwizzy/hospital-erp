...
<body>
  ...
  <div class="container">
      ...
      <div class="container clear_both padding_fix">
        <div class="noprint">
        <p style="text-align:right;"><A HREF="javascript:window.print()" class="noprint">Print Report</A>  | <A href="<?php echo base_url() ?>index.php/auth/index" class="noprint">Click to go back</A></p> 
       </div> 
    ...
    <h5 align="center">
         ...
         <div style="clear:both;"></div>
          <hr>
          <h4 align="center">Salaries Report</h4>
        </div>
        ...
        <thead style="background-color:#fcfcfc">
                        ...
                        <?php foreach ($salaries->result() as $salary):?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($salary->Basic_salary,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($salary->Monthly_salary,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo ($salary->Transport+$salary->Medical+$salary->risk+$salary->responsibility+$salary->strenuous+$salary->non_practising); ?></td>
