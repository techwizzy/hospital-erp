...
<body>
  ...
  <div id="page-wrap">
    ...
    <h5 align="center">
         ...
         <div style="clear:both;"></div>
          <hr>
          <h4 align="center"> PRODUCTS REORDER REPORT </h4>
        </div>
                    ...
                    <tr>
                        ...
                        <?php foreach ($items as $item):?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($item->Available_stock,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($item->Reorder_level,ENT_QUOTES,'UTF-8');?></td>
