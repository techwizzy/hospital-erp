...
<body>
  ...
  <div class="container">
      ...
      <div class="container clear_both padding_fix">
        <div class="noprint">
        <p style="text-align:right;"><A HREF="javascript:window.print()" class="noprint">Print Report</A>  | <A href="<?php echo base_url() ?>index.php/report/generate_loans_report" class="noprint">Click to go back</A></p> 
       </div> 
    ...
    <h5 align="center">
         ...
         <div style="clear:both;"></div>
          <hr>
          <h4 align="center">Loans & Savings Report</h4>
        </div>
        ...
        <thead style="background-color:#fcfcfc">
                        ...
                        <?php foreach ($salaries as $salary){ ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($salary->Loan_amount,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($salary->Period,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($salary->Start_date,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($salary->stop_date,ENT_QUOTES,'UTF-8');?></td>
                            </tr>
                        <?php  } ?>
                        </tbody>
