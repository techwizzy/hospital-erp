...
<body>
  ...
  <div id="page-wrap">
    ...
    <h5 align="center">
         ...
         <div style="clear:both;"></div>
          <hr>
          <h4 align="center"> STAFF REPORT </h4>
        </div>
      ...
      <table class="table table-bordered" width="1200">
        <thead style="background-color:#fcfcfc">
                        <tr>
                            <th class="col-xs-2">Staff no</th>
                            <th class="col-xs-2">First Name</th>
                            <th class="col-xs-2">Last Name</th>
                            <th class="col-xs-2">Phone</th>
                            <th class="col-xs-2">National ID</th>
                           
                            <th class="col-xs-2">Pin</th>
                            <th class="col-xs-2">NHIF NO</th>
                            <th class="col-xs-2">NSSF NO</th>
                            <th class="col-xs-2">work status</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($users as $user):?>
                            <tr>
                                <td><?php echo htmlspecialchars($user->Staff_no,ENT_QUOTES,'UTF-8');?></td>
                                ...
                                <td><?php echo htmlspecialchars($user->National_id,ENT_QUOTES,'UTF-8');?></td>
                                 <td><?php echo htmlspecialchars($user->Kra_pin,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($user->Nhif_no,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($user->Nssf_no,ENT_QUOTES,'UTF-8');?></td>
                                <td><?php echo htmlspecialchars($user->work,ENT_QUOTES,'UTF-8');?></td>
