            ...
            <div class="box-body">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                   ...
                   <?= form_open('report/get_clerks_sales','class="form-horizontal"');?>
              
                  <div class="form-group">
                   <select  class="form-control select2" style="width: 100%;" name="clerk_name" />
                        <option>Choose a Clerk</option>
                       
                       <option>ALL</option>
                       <?php foreach ($clerks as $clerk) { ?>
                       <option><?= $clerk->Username ?></option>
                       <?php } ?>
