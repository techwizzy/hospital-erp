...
<body>
  ...
  <div id="page-wrap">
    ...
    <h5 align="center">
         ...
         <div style="clear:both;"></div>
          <hr>
          <h4 align="center"> PRODUCTS  REPORT </h4>
        </div>
        ...
        <thead style="background-color:#fcfcfc">
                <thead>
                        <tr>
                            ...
                            <th class="col-xs-2">Available Stock</th>
                            <th class="col-xs-2">Reorder Level</th>
                            <th class="col-xs-2">Total Product value</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($items as $item):?>
                            <tr>
                                ...
                                <td><?php echo $this->cart->format_number($item->Available_stock);?></td>
                                <td><?php echo $this->cart->format_number($item->Reorder_level);?></td>
                                <td><?= $this->cart->format_number($item->Total_value) ?></td>
