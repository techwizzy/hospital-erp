            ...
            <div class="panel-body">
                  ...
                  <?php foreach ($supplier_data->result() as $row) { ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo date('d,l,F, Y',strtotime($row->Supplier_since)); ?></td>
                      ...
                      <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        <li><?php echo anchor("purchase/load_edit_supplier/".$row->Pin, 'Edit') ; ?></li>
                                        <li><?php echo anchor("purchase/load_edit_supplier/".$row->Pin, 'View_summary') ;?></li>
